...
%                 obj.ASaveParamVals{i} = [];
                obj.sANoElements(i) = uicontrol(obj.pALoops(i), ...
                    ...
                    'Units', 'pixels', ...
                    'Enable', enableStr, ...
                    'Position', [345 5 85 obj.componentHeight], ...
                    'BackgroundColor', [0.8 0.8 0.8], ...
                    'HorizontalAlignment', 'left', ...
                    'FontSize', obj.fontSize);
...
%                     obj.MRumpNo{i}{j} = 1;
                    obj.etMVector{i}{j} = uicontrol(obj.pALoops(i), ...
                        ...
                        'Units', 'pixels', ...
                        'Enable', enableStr, ...
                        'Position', [435 channelHeight-8 200 obj.componentHeight+6], ...
                        'BackgroundColor', 'white', ...
                        'HorizontalAlignment', 'left', ...
                        'FontSize', obj.fontSize);
%                     obj.MVector{i}{j} = [];
                    obj.sMNoElements{i}{j} = uicontrol(obj.pALoops(i), ...
                        ...
                        'Units', 'pixels', ...
                        'Enable', enableStr, ...
                        'Position', [640 channelHeight-5 75 obj.componentHeight], ...
                        'BackgroundColor', [0.8 0.8 0.8], ...
                        'HorizontalAlignment', 'left', ...
                        'FontSize', obj.fontSize);   
...
%             obj = guidata(obj.win);
            ...
            for i = obj.noLoops : -1 : 1
                for j = 1 : obj.noChannels(i)
                    ...
                    newLVData = obj.LVData.changeValue(type, event, channel, ramp, value );
                end
            end
...
%                     obj.imagingTimes(obj.position) );
            ...
            appData.save.saveOtherParamStr = obj.saveOtherParamStr;
            set(appData.ui.pmSaveParam, 'String', obj.saveParamsStr);
...
%                 end
            ...
            obj.noMeasurements = totElements;
...
%                 set(obj.etASaveParamVals(i), 'String', vec2str(o.ASaveParamVals{i}));
...
%             obj = guidata(obj.win);
        ...
        function [pIndex] = getPIndex(obj, object, objectA)
            pIndex = 0;
