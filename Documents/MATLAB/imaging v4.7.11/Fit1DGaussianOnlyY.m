...
%            
           ...
           set(appData.ui.stFitResultsFitFunction, 'String', 'Fit Function: A_y * {\ite}^{-(y-y_0)^2 / 2\sigma_y^2}+C_y');
...
%                ['R^2 = ' num2str(obj.xGof.rsquare)]});
           set(appData.ui.stFitResults2, 'String', {['A_y = ' num2str(obj.yRes.Ay) ], ...
               ['y_0 = ' formatNum((obj.yRes.y0-chipStart) * appData.data.camera.yPixSz, 'dis')], ...
