classdef FitOnlyMaxYCuts < FitTypes
...
%   Detailed explanation goes here
   ...
   properties ( SetAccess = protected)
       atomsNoYCuts = [];
       newCen = []; %pixels
       ySz = -1; %pixels, newCen-ySz : newCen+ySz-1
       NCuts = -1; %2*NCuts
   ...
   methods 
       function appData = analyze(obj, appData) % do the analysis
           obj.ySz = 4; %pixels, newCen-ySz : newCen+ySz-1
           obj.NCuts = 5; %2*NCuts
...
%                [obj.ROILeft : obj.ROIRight] - x0+1, [obj.ROITop : obj.ROIBottom] - y0+1);
           ...
           for i = 1 : 2*obj.NCuts
               obj.newCen(i) = yCen + 2*(i-obj.NCuts)*obj.ySz-obj.ySz;
               obj.atomsNoYCuts(i) = appData.options.calcs{appData.options.calcAtomsNo}.calcAtomsNo(appData, obj, pic, ...
                   [obj.ROILeft : obj.ROIRight] - x0+1, [obj.newCen(i)-obj.ySz : obj.newCen(i)+obj.ySz-1] - y0+1);
           end
           obj.atomsNoYCuts = obj.atomsNoYCuts / obj.atomsNoRef;
           ...
           appData.data.fits{appData.consts.fitTypes.onlyMaxYCuts} = obj;
...
%            text(50, 80, ['std = ' num2str(obj.stdv)], 'fontsize', 12);
            ...
            set(appData.ui.stFitResultsFitFunction, 'String', 'Fit Function: Only Max Y-Cuts');
